...
uv run .Codex/scripts/fetch_testrail.py get-sections 1 6 --match "keyword" --compact

# Get all cases in a section
uv run .Codex/scripts/fetch_testrail.py get-cases 1 6 --section-id <id>

# Get cases across multiple sections
uv run .Codex/scripts/fetch_testrail.py get-cases-for-sections 1 6 --match "keyword"

# Create a section in the v2 suite
uv run .Codex/scripts/fetch_testrail.py add-section 1 <v2_suite_id> "<name>" <parent_id>

# Batch create cases in a section
uv run .Codex/scripts/fetch_testrail.py batch-add-cases <section_id> --json-file <path>
```
